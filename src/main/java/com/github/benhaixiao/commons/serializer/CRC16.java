...
public class CRC16 {  
    ...
    public static void main(String[] args) {  
        ...
        int crc = CRC16.calcCrc16("sadfasdf".getBytes());
        System.out.println(crc);
        System.out.println( CRC16.calcCrc16("sadfassdf".getBytes()));
        System.out.println( CRC16.calcCrc16("sadfassd f".getBytes()));
        System.out.println( CRC16.calcCrc16("sadfassd f2".getBytes()));
    }  
}  